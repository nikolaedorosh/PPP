        ...
        <div className="line-diagram">
          ...
          >
            ...
            <Legend layout='horizontal'
              ...
              iconType="line" />
            <Line type="monotone" dataKey="targetKcal" stroke="#ffd500" strokeWidth={4}/>
            <Line type="monotone" dataKey="targetFats" stroke="#73ff00" strokeWidth={2}/>
            <Line type="monotone" dataKey="targetProteins" stroke="#0004ff"strokeWidth={2} />
            <Line
              type="monotone"
